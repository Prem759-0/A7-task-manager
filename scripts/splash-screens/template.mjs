...
const template = ({ width, height, mode }) => {
  ...
  return `
     <html>
      ...
      <body>
        <div class="container">
          <img src="https://raw.githubusercontent.com/Prem759-0/A7-task-manager/refs/heads/main/public/logo.svg" class="logo" alt="App Logo" />
          <div class="app-name">
        ...
        <div class="attribution">
          ...
          <div class="attribution-box">
            <img src="https://avatars.githubusercontent.com/u/85953204?v=4" alt="@Prem759-0" />
            <span>@Prem759-0</span>
          </div>
        </div>
      </body>
